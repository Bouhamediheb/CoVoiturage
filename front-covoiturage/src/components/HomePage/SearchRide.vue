...
export default {
  ...
  methods: {
    ...
    filterStartPoint() {
      this.startPointFiltered = this.governorates.filter((city) =>
        city.toLowerCase().startsWith(this.startPoint.toLowerCase())
      );
    },
    filterEndPoint() {
      this.endPointFiltered = this.governorates.filter((city) =>
        city.toLowerCase().startsWith(this.endPoint.toLowerCase())
      );
    },
